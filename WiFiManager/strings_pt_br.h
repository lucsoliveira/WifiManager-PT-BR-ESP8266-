...
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>Não conectado</strong> em {v}{r}</div>";
...
const char HTTP_HELP[]             PROGMEM =
 ...
 "<tr><td><a href='/'>/</a></td>"
 "<td> Página do menu. </td> </tr>"
 "<tr><td><a href='/wifi'>/wifi</a></td>"
 "<td> Mostrar resultados da verificação de WiFi e entrar na configuração de WiFi. (/ 0wifi noscan) </td> </tr>"
 "<tr><td><a href='/wifisave'>/wifisave</a></td>"
 "<td> Salvar informações de configuração de WiFi e configurar o dispositivo. Variáveis necessárias fornecidas. </td> </tr>"
 ...
 "<td>Sair do Config Portal, o portal de configurações será fechado </td> </tr>"
 "<tr><td><a href='/restart'>/restart</a></td>"
 "<td>Reinicialize o dispositivo </td> </tr>"
 "<tr><td><a href='/erase'>/erase</a></td>"
 "<td> Apague a configuração WiFi e reinicie o dispositivo. O dispositivo não se reconectará a uma rede até que novos dados de configuração WiFi sejam inseridos. </td> </tr>"
  "</table>"
 "<p /> Mais informações sobre WiFiManager em <a href='https://github.com/tzapu/WiFiManager'> https://github.com/tzapu/WiFiManager </a>.";
...
// Info html
  ...
  const char HTTP_INFO_lastreset[]    PROGMEM = "<dt>Razão da última reinicialização</dt><dd>CPU0: {1}<br/>CPU1: {2}</dd>";
  const char HTTP_INFO_aphost[]       PROGMEM = "<dt>Nome do host do ponto de acesso</dt><dd>{1}</dd>";  
#else 
	const char HTTP_INFO_esphead[]    PROGMEM = "<h3>esp8266</h3><hr><dl>";
	const char HTTP_INFO_flashsize[]  PROGMEM = "<dt>Tamanho real da memória Flash</dt><dd>{1} bytes</dd>";
	...
	const char HTTP_INFO_memsketch[]  PROGMEM = "<dt>Memória - Tamanho do esboço</dt><dd>Bytes usados / total<br/>{1} / {2}";
	const char HTTP_INFO_memsmeter[]  PROGMEM = "<br/><progress value='{1}' max='{2}'></progress></dd>";
	const char HTTP_INFO_lastreset[]  PROGMEM = "<dt>Razão da última reinicialização</dt><dd>{1}</dd>";
#endif

const char HTTP_INFO_freeheap[]   PROGMEM = "<dt>Memória - Pilha Livre</dt><dd>{1} bytes disponíveis</dd>"; 
const char HTTP_INFO_wifihead[]   PROGMEM = "<br/><h3>WiFi</h3><hr>";
const char HTTP_INFO_uptime[]     PROGMEM = "<dt>Tempo de atividade</dt><dd>{1} Mins {2} Seg.</dd>";
const char HTTP_INFO_chipid[]     PROGMEM = "<dt>Chip ID</dt><dd>{1}</dd>";
const char HTTP_INFO_idesize[]    PROGMEM = "<dt>Tamanho Flash</dt><dd>{1} bytes</dd>";
const char HTTP_INFO_sdkver[]     PROGMEM = "<dt>Versão SDK</dt><dd>{1}</dd>";
const char HTTP_INFO_cpufreq[]    PROGMEM = "<dt>Freqüência da CPU</dt><dd>{1}MHz</dd>";
...
const char S_nonetworks[]         PROGMEM = "Nenhuma rede encontrada. Atualize para verificar novamente.";
const char S_staticip[]           PROGMEM = "I.P. estático";
...
const char S_closing[]            PROGMEM = "Você pode fechar a página, o portal continuará a funcionar";
